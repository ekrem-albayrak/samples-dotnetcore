...
namespace FORCAM.BridgeAPI.Model {
  ...
  /// </summary>
  [DataContract]
  public class ScheduledOperatingTimes {
    /// <summary>
    ...
    public WorkplaceScheduledOperatingTimesPropertiesWSModel Properties { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ScheduledOperatingTimes {\n");
