...
namespace FORCAM.BridgeAPI.Model {
  ...
  /// </summary>
  [DataContract]
  public class WorkplaceRequiredSkillsCollectionWSModel {
    /// <summary>
    ...
    public List<WorkplaceRequiredSkillWSModel> Elements { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class WorkplaceRequiredSkillsCollectionWSModel {\n");
