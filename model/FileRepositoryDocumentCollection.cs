...
namespace FORCAM.BridgeAPI.Model {
  ...
  /// </summary>
  [DataContract]
  public class FileRepositoryDocumentCollection {
    /// <summary>
    /// Contains the embedded documents.
    /// </summary>
    /// <value>Contains the embedded documents.</value>
    [DataMember(Name="_embedded", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "_embedded")]
    public EmbeddedFileRepositoryDocuments Embedded { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class FileRepositoryDocumentCollection {\n");
