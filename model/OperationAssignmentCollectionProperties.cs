...
namespace FORCAM.BridgeAPI.Model {
  ...
  /// </summary>
  [DataContract]
  public class OperationAssignmentCollectionProperties {
    /// <summary>
    ...
    public List<OperationAssignment> Elements { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class OperationAssignmentCollectionProperties {\n");
