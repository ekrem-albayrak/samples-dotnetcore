...
namespace FORCAM.BridgeAPI.Model {
  ...
  /// </summary>
  [DataContract]
  public class StaffMemberScheduledWorkingTimes {
    /// <summary>
    ...
    public StaffMemberScheduledWorkingTimesProperties Properties { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class StaffMemberScheduledWorkingTimes {\n");
