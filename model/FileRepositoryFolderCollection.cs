...
namespace FORCAM.BridgeAPI.Model {
  ...
  /// </summary>
  [DataContract]
  public class FileRepositoryFolderCollection {
    /// <summary>
    /// Contains the embedded folders.
    /// </summary>
    /// <value>Contains the embedded folders.</value>
    [DataMember(Name="_embedded", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "_embedded")]
    public EmbeddedFileRepositoryFolders Embedded { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class FileRepositoryFolderCollection {\n");
