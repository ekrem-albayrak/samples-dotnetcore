...
namespace FORCAM.BridgeAPI.Model {
  ...
  /// </summary>
  [DataContract]
  public class StaffMemberRecordedActivitiesCollection {
    /// <summary>
    ...
    public StaffMemberRecordedActivitiesProperties Properties { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class StaffMemberRecordedActivitiesCollection {\n");
