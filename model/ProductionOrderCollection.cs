...
namespace FORCAM.BridgeAPI.Model {
  ...
  public class ProductionOrderCollection {
    /// <summary>
    /// Contains the embedded production orders
    /// </summary>
    /// <value>Contains the embedded production orders</value>
    [DataMember(Name="_embedded", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "_embedded")]
    public EmbeddedProductionOrders Embedded { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ProductionOrderCollection {\n");
