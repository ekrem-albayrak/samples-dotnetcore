...
namespace FORCAM.BridgeAPI.Model {
  ...
  /// </summary>
  [DataContract]
  public class StaffMembersScheduledWorkingTimes {
    /// <summary>
    ...
    public StaffMembersScheduledWorkingTimesProperties Properties { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class StaffMembersScheduledWorkingTimes {\n");
