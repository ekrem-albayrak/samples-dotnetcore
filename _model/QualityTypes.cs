...
namespace FORCAM.BridgeAPI.Model
{
    ...
    {
        /// <summary>
        /// Contains the embedded quality types
        /// </summary>
        /// <value>Contains the embedded quality types</value>
        [DataMember(Name = "_embedded", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "_embedded")]
        public EmbeddedQualityTypes Embedded { get; set; }
