...
namespace FORCAM.BridgeAPI.Model {
  ...
  /// </summary>
  [DataContract]
  public class RecordedOperationPhaseCollection {
    /// <summary>
    ...
    /// <summary>
    /// The operation recoded phase collection properties
    /// </summary>
    /// <value>The operation recoded phase collection properties</value>
    [DataMember(Name="properties", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "properties")]
    public OperationPhaseCollectionProperties Properties { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class RecordedOperationPhaseCollection {\n");
