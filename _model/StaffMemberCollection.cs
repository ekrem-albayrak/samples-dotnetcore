...
namespace FORCAM.BridgeAPI.Model
{
    ...
    {
        /// <summary>
        /// Contains the embedded persons.
        /// </summary>
        /// <value>Contains the embedded persons.</value>
        [DataMember(Name = "_embedded", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "_embedded")]
        public EmbeddedStaffMembers Embedded { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StaffMemberCollection {\n");
