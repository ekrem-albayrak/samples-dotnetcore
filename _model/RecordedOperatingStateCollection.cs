...
namespace FORCAM.BridgeAPI.Model {
  ...
  /// </summary>
  [DataContract]
  public class RecordedOperatingStateCollection {
    /// <summary>
    ...
    public RecordedOperatingStatesPropertiesModel Properties { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class RecordedOperatingStateCollection {\n");
