...
namespace FORCAM.BridgeAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public class StatusDefinitionCollection
    {
        /// <summary>
        /// Contains the embedded status definitions.
        /// </summary>
        /// <value>Contains the embedded status definitions.</value>
        [DataMember(Name = "_embedded", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "_embedded")]
        public EmbeddedStatusDefinition Embedded { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StatusDefinitionCollection {\n");
