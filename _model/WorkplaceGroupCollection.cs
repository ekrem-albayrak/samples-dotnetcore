...
namespace FORCAM.BridgeAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public class WorkplaceGroupCollection
    {
        /// <summary>
        /// Contains the embedded workplace groups.
        /// </summary>
        /// <value>Contains the embedded workplace groups.</value>
        [DataMember(Name = "_embedded", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "_embedded")]
        public EmbeddedWorkplaceGroups Embedded { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorkplaceGroupCollection {\n");
