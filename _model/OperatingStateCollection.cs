...
namespace FORCAM.BridgeAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public class OperatingStateCollection
    {
        /// <summary>
        /// Contains the embedded operating states.
        /// </summary>
        /// <value>Contains the embedded operating states.</value>
        [DataMember(Name = "_embedded", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "_embedded")]
        public EmbeddedOperatingStates Embedded { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OperatingStateCollection {\n");
