...
namespace FORCAM.BridgeAPI.Model {
  ...
  /// </summary>
  [DataContract]
  public class QualityDetailCollection {
    /// <summary>
    /// Contains the embedded quality details.
    /// </summary>
    /// <value>Contains the embedded quality details.</value>
    [DataMember(Name="_embedded", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "_embedded")]
    public EmbeddedQualityDetails Embedded { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class QualityDetailCollection {\n");
