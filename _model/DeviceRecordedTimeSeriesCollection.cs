...
namespace FORCAM.BridgeAPI.Model {
  ...
  /// </summary>
  [DataContract]
  public class DeviceRecordedTimeSeriesCollection {
    /// <summary>
    ...
    public DeviceRecordedTimeSeriesCollectionProperties Properties { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class DeviceRecordedTimeSeriesCollection {\n");
