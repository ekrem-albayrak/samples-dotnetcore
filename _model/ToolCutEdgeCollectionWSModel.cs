...
namespace FORCAM.BridgeAPI.Model {
  ...
  /// </summary>
  [DataContract]
  public class ToolCutEdgeCollectionWSModel {
    /// <summary>
    /// Contains the embedded tool edges.
    /// </summary>
    /// <value>Contains the embedded tool edges.</value>
    [DataMember(Name="_embedded", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "_embedded")]
    public EmbeddedToolEdges Embedded { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ToolCutEdgeCollectionWSModel {\n");
