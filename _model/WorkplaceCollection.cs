...
namespace FORCAM.BridgeAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public class WorkplaceCollection
    {
        /// <summary>
        /// Contains the embedded workplaces.
        /// </summary>
        /// <value>Contains the embedded workplaces.</value>
        [DataMember(Name = "_embedded", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "_embedded")]
        public EmbeddedWorkplaces Embedded { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorkplaceCollection {\n");
