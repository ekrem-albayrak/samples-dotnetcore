...
namespace FORCAM.BridgeAPI.Model {
  ...
  /// </summary>
  [DataContract]
  public class CallbackCollectionWSModel {
    /// <summary>
    /// Contains the callbacks.
    /// </summary>
    /// <value>Contains the callbacks.</value>
    [DataMember(Name="_embedded", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "_embedded")]
    public EmbeddedCallbackWSModel Embedded { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class CallbackCollectionWSModel {\n");
