...
namespace FORCAM.BridgeAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ShiftTypeCollection
    {
        /// <summary>
        /// Contains the embedded shift type.
        /// </summary>
        /// <value>Contains the embedded shift type.</value>
        [DataMember(Name = "_embedded", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "_embedded")]
        public EmbeddedShiftTypes Embedded { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShiftTypeCollection {\n");
