...
namespace FORCAM.BridgeAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ToolOrderCollectionWSModel
    {
        /// <summary>
        /// Contains the embedded tools.
        /// </summary>
        /// <value>Contains the embedded tools.</value>
        [DataMember(Name = "_embedded", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "_embedded")]
        public EmbeddedToolOrders Embedded { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ToolOrderCollectionWSModel {\n");
