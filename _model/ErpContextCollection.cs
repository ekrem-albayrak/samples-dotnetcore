...
namespace FORCAM.BridgeAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ErpContextCollection
    {
        /// <summary>
        /// Contains the embedded erp contexts.
        /// </summary>
        /// <value>Contains the embedded erp contexts.</value>
        [DataMember(Name = "_embedded", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "_embedded")]
        public EmbeddedErpContexts Embedded { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ErpContextCollection {\n");
