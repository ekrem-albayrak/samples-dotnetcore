...
namespace FORCAM.BridgeAPI.Model {
  ...
  /// </summary>
  [DataContract]
  public class RecordedOutputQuantitiesCollection {
    /// <summary>
    ...
    public RecordedOperationOutputQuantitiesProperties Properties { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class RecordedOutputQuantitiesCollection {\n");
